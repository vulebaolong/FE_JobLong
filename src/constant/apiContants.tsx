...
// export const BASE_URL_API = isProduction ? "https://l9-learning.onrender.com/api/v1" : "http://localhost:3001/api/v1";
export const BASE_URL_API = 'http://localhost:6969/api/v1';
export const BASE_URL_SERVER = 'http://localhost:6969';
